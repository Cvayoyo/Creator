    ...
    while True:
        ...
        while True:
            try:
                ...
                time.sleep(3)
                wait_and_click(driver, '#yDmH0d > div.uW2Fw-Sx9Kwc.uW2Fw-Sx9Kwc-OWXEXe-n2to0e.uW2Fw-Sx9Kwc-OWXEXe-wdeprb-MD85tf-DKzjMe.iteLLc.uW2Fw-Sx9Kwc-OWXEXe-FNFY6c > div.uW2Fw-wzTsW > div > div.uW2Fw-T0kwCb > div.qsqhnc > div > button')
                                ...
                                try:
                                    ...
                                    try:
                                        ...
                                        try:
                                            ...
                                            slos = 0
                                        try:
                                            wait_and_send(driver, "#password > div.aCsJod.oJeWuf > div > div.Xb9hP > input", pwd)
                                            time.sleep(1)
...
while True:
    if choser == 1 or choser == "1":
        ...
        try:
            email_o, pwd_o,sec_o = main(bacot[0],bacot[1],bacot[2])
            href_links = []
            mail_list = []
            driver = Driver(uc=True)
            if login(email_o, pwd_o, sec_o):
                time.sleep(1)
                prom()
                time.sleep(2)
                family()
                ...
                for i in range(len(mail_list)):
                    with open('../result_anak.txt', 'a') as result_file:
                        result_file.write(f"{mail_list[i]}|{email_o}\n")
                with open('../result_ortu.txt', 'a') as result_file:
                    result_file.write(f"{email_o}|{pwd_o}|{sec_o}\n")
                # change_password()
                time.sleep(2)
                loqout()
                time.sleep(2)
